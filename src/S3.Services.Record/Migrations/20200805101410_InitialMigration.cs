        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CAPercentage = table.Column<float>(nullable: true),
                    FirstExamPercentage = table.Column<float>(nullable: false),
                    SecondExamPercentage = table.Column<float>(nullable: true),
                    HomeworkPercentage = table.Column<float>(nullable: true),
                    ClassActivitiesPercentage = table.Column<float>(nullable: true),
