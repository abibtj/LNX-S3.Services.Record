...
//using S3.Services.Record.ClassSubjectScores.Queries;

//namespace S3.Services.Record.Controllers
//{
//    //[JwtAuth(Roles = "superadmin, admin, teacher")]
//    public class ClassSubjectScoresController : BaseController
//    {
//        public ClassSubjectScoresController(IBusPublisher busPublisher, IDispatcher dispatcher, ITracer tracer) 
...
//            => Single(await QueryAsync(new GetClassSubjectScoresQuery(id, include)));

//        [HttpPost("create")]
//        public async Task<IActionResult> Create(CreateClassSubjectScoresCommand command)
//            => await SendAsync(command, resource: "classSubjectScores");

//        [HttpPut("update")]
//        public async Task<IActionResult> Update(UpdateClassSubjectScoresCommand command)
//        => await SendAsync(command, resourceId: command.Id, resource: "classSubjectScores");

//        [HttpDelete("delete/{id:guid}")]
//        public async Task<IActionResult> Delete(Guid id)
//            => await SendAsync(new DeleteClassSubjectScoresCommand(id), resourceId: id, resource: "classSubjectScores");
//    }
//}
