...
//{
//    public class CreateClassSubjectScoresCommandValidator : AbstractValidator<CreateClassSubjectScoresCommand>
//    {
//        public CreateClassSubjectScoresCommandValidator()
//        {
//            RuleFor(x => x.ClassId)
